...
import { batchOptions, courseOptions, daysOptions } from "@/data";
...
export default function AddStudentsPage() {
  ...
  const handleExcelUpload = async () => {
    ...
    try {
      ...
      const res = await fetch(`${BackendURL}/api/upload-students`, {
        method: "POST",
        headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch(`${BackendURL}/api/individual-data`, {
        method: "POST",
        headers: {
